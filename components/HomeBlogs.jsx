...
const HomeBlogs = () => {
  return (
    <div className="bg-[#000049] px-20 py-20">
      ...
      <div className="grid grid-cols-3 gap-x-5 mt-[50px]">
        <div className="h-[555px] rounded-[8px] w-full bg-white bg-opacity-15 relative">
          <img src="/Images/HBlog1.png" alt="Blog1" />
        ...
        <div className="h-[555px] rounded-[8px] w-full bg-white bg-opacity-15 relative">
          <img src="/Images/HBlog2.png" alt="Blog2" />
          <div className="text-white p-7">
            <p className="font-inter text-[16px] font-normal flex items-center opacity-60">
              DevBoost{" "}
              <span className="mx-3">
            ...
            <p className="font-inter text-[16px] font-normal leading-[24px] mt-3 opacity-90">
              How clients use DevBoost to analyze <br /> data points and drive key
              business outcomes.
            </p>
            <div className="font-inter font-semibold text-[16px] text-[#1FFFA3] mt-4 flex items-center cursor-pointer space-x-2 hover:space-x-3 transition-all duration-100 w-[140px] absolute bottom-7 left-7">
              <p className="">Read More </p>
        ...
        <div className="h-[555px] rounded-[8px] w-full bg-white bg-opacity-15 relative">
          <img src="/Images/HBlog3.png" alt="Blog3" />
          <div className="text-white p-7 ">
            <p className="font-inter text-[16px] font-normal flex items-center opacity-60">
              DevBoost{" "}
              <span className="mx-3">
            ...
            <p className="font-inter text-[24px] font-semibold leading-[30px] mt-3">
              Latest Techniques For <br /> Strategy & Planning
            </p>
            <p className="font-inter text-[16px] font-normal leading-[24px] mt-3 opacity-90">
