        ...
        <div className="w-full  border border-[#004C3F] rounded-[20px] flex">
          <div className="w-[45%] bg-[#004C3F] h-full p-10 rounded-l-[20px]">
            ...
            <p className="font-inter  text-[16px] text-white mt-4">
              ...
              You can either complete the form or directly reach out to us with
          ...
          <div className="p-10 w-[55%]">
            <form className="">
              <div className="space-y-6">
                ...
                <div className="">
                  <p className="font-inter text-[#000049] mb-2">Your Message</p>
                  <input
                    type="text"
          ...
          <div className="bg-[#f5f5f5] hidden  lg:space-x-4 lg:flex flex-col lg:flex-row lg:w-[461px] p-6 lg:rounded-[8px] ">
            ...
            >
              <div className="space-y-3">
                ...
                <p>
                Lorem ipsum dolor sit amet <br /> consectetur. Phasellus ante donec <br /> quis erat Tortor 
                </p>
                <p className="text-xl flex items-center space-x-2">
                  <span>4.2</span>{" "}
                  <img src="/Images/ratings.png" alt="4 stars" className="w-[68px]" />
                </p>
            ...
            <div>
              <img src="/Images/direction.png" alt="" className="w-[24px] mx-auto" />
